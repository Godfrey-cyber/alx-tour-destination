...
const LandingPage = () => {
	...
	return (
		<div className="flex w-full h-screen flex flex-col relative">
	        ...
	        <img src="https://images.pexels.com/photos/1544376/pexels-photo-1544376.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className="w-full h-full object-cover bg-fixed"/>
	        <div className="mt-5 flex space-x-6 items-center">
	      	...
	      	<div className="flex flex-col lg:justify-start justify-center lg:items-start items-center space-y-3 absolute top-1/2 bottom-1/2 transform -translate-y-1/2 translate-x-1/2 left-2 z-50 w-1/2 lg:w-1/3">
	      		<h2 className="text-lg lg:text-start text-center text-orange-500 font-semibold">Trusted by millions worldwide</h2>
	      		<p className="text-4xl lg:text-start text-center text-white font-bold">Welcome to world's best booking site</p>
	      		<p className="text-sm lg:text-start text-center text-white font-semibold">Choose from houses, cabins, villas and more</p>
					<button onClick={() => navigate("/home")} className="text-sm font-semibold text-white bg-orange-600 w-fit rounded-full px-6 py-3 my-4">Search Destination</button>
	      	</div>
	      	<Content />
	      	<About />
		</div>
