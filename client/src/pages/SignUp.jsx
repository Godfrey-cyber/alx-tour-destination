			...
			<div className="flex flex-col space-y-6 h-92 w-1/3">
				...
				<div className="flex flex-col space-y-6">
					<form action="" className="flex flex-col space-y-4">
						...
						<div className="flex items-center text-xs text-gray-400 justify-self-center">Already have an account?<span onClick={() => navigate("/login")} className="cursor-pointer text-orange-400 hover:font-semibold transition-all delay-200 ml-2">Login here</span></div>
					</form>
