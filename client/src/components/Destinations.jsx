...
const Destinations = () => {
	return (
		<div className="w-full h-screen flex flex-col bg-pink-50 justify-center items-center px-30">
			<span className="flex flex-col items-center space-y-4 my-3">
				...
				<p className="text-4xl text-black font-bold">Trending Destinations</p>
			</span>
