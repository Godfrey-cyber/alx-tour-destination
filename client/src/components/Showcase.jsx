	...
	return (
		<div className="w-full h-screen flex flex-col relative">
	        ...
	        <div className="mt-5 flex space-x-6 items-center">
	      	...
	      	<div className="mt-5 flex items-center space-x-2 absolute left-1/2 bottom-15 transform -translate-x-1/2 z-50">
	      	...
	      	<div className="flex flex-col justify-start space-y-3 absolute top-1/2 bottom-1/2 transform -translate-y-1/2 translate-x-1/2 left-2 w-1/3">
	      		<h2 className="text-lg text-orange-500 font-semibold">{showcaseContent[currentIndex]?.title}</h2>
	      		<p className="text-4xl text-white font-bold">{showcaseContent[currentIndex]?.large}</p>
	      		<p className="text-sm text-white font-semibold">{showcaseContent[currentIndex]?.small}</p>
	      	</div>
	      	<SearchBar />
		</div>
	)
